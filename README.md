...
where \<id\> is the package and repository name.

### Update of Python Package Repositories

This feature is currently under development. Should there be any update to the template, This repository will be able to update the python package repositories generated using this repository in the future when this feature is rolled out.
